...
const Blog = () => {
    return (
        <>
            <div ref={ref} className='md:mx-60 mt-6 text-center'>
            ...
            <div className='text-center mt-3'>
                <Pdf targetRef={ref} filename="blog.pdf"  x={.1} y={.1} scale={0.8}>
                    {({ toPdf }) => <button className='bg-gray-600 text-white p-2 rounded-sm' onClick={toPdf}>Generate to Pdf</button>}
                </Pdf>
            </div>
        </>
    );f
